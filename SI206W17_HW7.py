...
def get_user_tweets(user):
	...
	if unique_identifier in CACHE_DICTION: 
		...
		twitter_results = api.user_timeline() # get it from the internet
...
for tweet in umsi_tweets:
	tweet_vals = (tweet["id"],tweet["user"]["screen_name"], tweet["created_at"], tweet["text"], tweet["retweet_count"])
	cur.execute(statement, tweet_vals)
